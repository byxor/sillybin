...
public final class SearchServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<LibraryProtos.SearchRequest,
      LibraryProtos.SearchResponse> getSearchMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Search",
      requestType = LibraryProtos.SearchRequest.class,
      responseType = LibraryProtos.SearchResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<LibraryProtos.SearchRequest,
      LibraryProtos.SearchResponse> getSearchMethod() {
    io.grpc.MethodDescriptor<LibraryProtos.SearchRequest, LibraryProtos.SearchResponse> getSearchMethod;
      ...
      synchronized (SearchServiceGrpc.class) {
        if ((getSearchMethod = SearchServiceGrpc.getSearchMethod) == null) {
          SearchServiceGrpc.getSearchMethod = getSearchMethod = 
              io.grpc.MethodDescriptor.<LibraryProtos.SearchRequest, LibraryProtos.SearchResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "SearchService", "Search"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  LibraryProtos.SearchRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  LibraryProtos.SearchResponse.getDefaultInstance()))
  ...
  public static abstract class SearchServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void search(LibraryProtos.SearchRequest request,
        io.grpc.stub.StreamObserver<LibraryProtos.SearchResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                LibraryProtos.SearchRequest,
                LibraryProtos.SearchResponse>(
  ...
  public static final class SearchServiceBlockingStub extends io.grpc.stub.AbstractStub<SearchServiceBlockingStub> {
    ...
    /**
     */
    public LibraryProtos.SearchResponse search(LibraryProtos.SearchRequest request) {
  ...
  public static final class SearchServiceFutureStub extends io.grpc.stub.AbstractStub<SearchServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<LibraryProtos.SearchResponse> search(
        LibraryProtos.SearchRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEARCH:
          serviceImpl.search((LibraryProtos.SearchRequest) request,
              (io.grpc.stub.StreamObserver<LibraryProtos.SearchResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class SearchServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return LibraryProtos.getDescriptor();
    }
